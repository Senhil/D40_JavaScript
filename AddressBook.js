...
function countContacts(contactArray){
 ...
 function addContact(addressBookArray,firstName,lastName){
    if(addressBookArray.find((contact)=>(contact.firstName+" "+contact.lastName)==(firstName+" "+lastName))){   
        ...
        try{
            addressBookArray.push(new Contact(firstName,lastName,'Gandhi Nagar','Coimbatore','TamilNadu',667004,'91 8337036987','jeeva@gmail.com'));
...
try {
    addressBookArray.push(new Contact("Vikas", "Sri", "KK Nagar", "Coimbatore", "TamilNadu", 666004, "91 8764755210", "vikas@gmail.com"));
    addressBookArray.push(new Contact("Kannan", "thanga", "KP Nagar", "Coimbatore", "TamilNadu", 657004, "91 6998876210", "kannan@gmail.com"));
